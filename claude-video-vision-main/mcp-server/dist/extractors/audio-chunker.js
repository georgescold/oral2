...
const SILENCE_PARAMS = {
    default: "silencedetect=n=-40dB:d=0.5",
    loose: "silencedetect=n=-30dB:d=0.2",
};
export async function detectSilencesReal(videoPath, threshold) {
...
function findNearestSilence(boundary, silences) {
...
export async function planChunks(videoPath, durationSec, config, detector = detectSilencesReal) {
